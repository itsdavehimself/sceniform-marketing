      ...
      <div className={styles.contentWrapper}>
        ...
        <section className={styles.termsSection}>
          <p>
            ...
            for an account or using the Service, you agree to be bound by these
            Terms.
          </p>
        </section>
        ...
        <section className={styles.termsSection}>
          ...
          <div className={styles.warningBlock}>
            ...
            <p>
              ...
              differences, but we do not guarantee the functional success, logic
              integrity, or safety of any scenario deployed through our
          ...
          <ul>
            <li>
              ...
              applications (e.g., Airtable, Salesforce, Slack) triggered by your
              deployments.
            </li>
            <li>
        ...
        <section className={styles.termsSection}>
          ...
          <p>
            ...
            your Sceniform login credentials and the Make.com API keys you
        ...
        <section className={styles.termsSection}>
          ...
          <p>
            ...
            your use of Sceniform is also subject to Make's Terms of Service and
          ...
          <ul>
            ...
            <li>
              ...
              immediately if your API usage causes excessive strain on our proxy
              servers or violates these terms.
            </li>
          </ul>
        </section>
        ...
        <section className={styles.termsSection}>
          ...
          <p>
            ...
            will be uninterrupted, error-free, or completely secure. We reserve
