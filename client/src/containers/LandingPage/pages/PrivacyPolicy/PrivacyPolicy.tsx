      ...
      <div className={styles.contentWrapper}>
        ...
        <section className={styles.policySection}>
          ...
          <ul>
            ...
            <li>
              <strong>Make.com Connection Data:</strong> When you add a Make.com
              API key, we collect the key itself, alongside metadata such as
              your Make.com Organization ID, Team ID, and Zone (e.g.,{" "}
              <code>us1</code>).
            </li>
          </ul>
        </section>
        ...
        <section className={styles.policySection}>
          ...
          <p>
            ...
            <strong>Zero Data Retention</strong> policy for your actual scenario
            workflows.
          </p>
          <ul>
            <li>
              ...
              fetches the JSON directly from Make.com via API and processes the
              logic (modules, mappings, filters) entirely in memory.
            </li>
            <li>
        ...
        <section className={styles.policySection}>
          ...
          <p>
            To run Sceniform securely and reliably, we use the following vetted
          ...
          <p>
            <em>
              (Note: We do not currently use AI models to process your data. If
              we introduce AI-powered features in the future, we will update
              this policy and ensure strict zero-data-retention agreements are
              in place so your blueprints are never used to train public
              models).
            </em>
          </p>
        </section>
        ...
        <section className={styles.policySection}>
          ...
          <ul>
            ...
            <li>
              <strong>Organization Deletion:</strong> If you are the sole member
              of an Organization and you delete your account (or if the last
              remaining user in an Organization deletes theirs), the entire
              Organization—including all encrypted Make.com API keys and
              metadata—is permanently destroyed.
            </li>
            <li>
        ...
        <section className={styles.policySection}>
          ...
          <p>
            As we build new features (such as audit logs or deployment fleets),
            our data practices may evolve. We will notify you of any significant
            changes to this policy via the email address associated with your
            account.
          </p>
        </section>
        ...
        <section className={styles.policySection}>
          ...
          <p>
            ...
            practices, or wish to submit a data deletion request, please contact
            us at:
          </p>
